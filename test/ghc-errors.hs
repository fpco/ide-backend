  ...
  , ( "Type information 1"
    , withConfiguredSession (defOpts ++ ["-package parallel"]) $ \session -> do
        ...
        let expectedSymDefMap = unlines $ sort
              [ "A.hs:3:1 (binder): a :: GHC.Types.Int (A.hs:3:1)"
              , "A.hs:4:1 (binder): b :: GHC.Types.Int (A.hs:4:1)"
              , "A.hs:4:5: A.a :: GHC.Types.Int (A.hs:3:1)"
              , "A.hs:4:7: GHC.Num.+ :: forall a. GHC.Num.Num a => a -> a -> a (<no location info>)"
              , "B.hs:4:1 (binder): c :: GHC.Types.Int (B.hs:4:1)"
              , "B.hs:4:9 (binder): e :: GHC.Types.Int (B.hs:4:9)"
              ...
              , "B.hs:8:1 (binder): d :: GHC.Types.Int -> A.T (B.hs:8:1)"
              ...
              , "B.hs:9:1 (binder): e :: GHC.Types.Bool (B.hs:9:1)"
