  ...
  , ( "Type information 1"
    , withConfiguredSession (defOpts ++ ["-package parallel", "-XScopedTypeVariables"]) $ \session -> do
        ...
        let expectedIdMap =
              ...
              , "B.hs:10:6-11 (TvName, binder): a ::  (type unknown) (B.hs:10:6-11)"
              ...
              , "B.hs:12:13 (TvName, binder): a ::  (type unknown) (B.hs:12:13)"
              ...
              , "B.hs:14:13 (TvName, binder): a ::  (type unknown) (B.hs:14:13)"
