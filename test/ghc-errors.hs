  ...
  , ( "Type information 1"
    , withConfiguredSession (defOpts ++ ["-package parallel"]) $ \session -> do
        ...
        let expectedIdMap = unlines $ sort
              ...
              , "A.hs:4:7: base/GHC-Num.html#v: GHC.Num.+ :: forall a. GHC.Num.Num a => a -> a -> a (<no location info>)"
              , "B.hs:4:1 (binder): #v: c :: GHC.Types.Int (B.hs:4:1)"
              , "B.hs:4:9 (binder): #v: e :: GHC.Types.Int (B.hs:4:9)"
              , "B.hs:5:8: main/A.html#v: A.b :: GHC.Types.Int (A.hs:4:1)"
              , "B.hs:5:10: base/GHC-Num.html#v: GHC.Num.+ :: forall a. GHC.Num.Num a => a -> a -> a (<no location info>)"
              , "B.hs:5:14: base/GHC-Num.html#v: GHC.Num.+ :: forall a. GHC.Num.Num a => a -> a -> a (<no location info>)"
              , "B.hs:5:16: #v: d :: GHC.Types.Int (B.hs:6:9)"
              , "B.hs:5:18: base/GHC-Num.html#v: GHC.Num.+ :: forall a. GHC.Num.Num a => a -> a -> a (<no location info>)"
              , "B.hs:5:20: #v: e :: GHC.Types.Int (B.hs:4:9)"
              , "B.hs:8:1 (binder): #v: d :: GHC.Types.Int -> A.T (B.hs:8:1)"
              , "B.hs:8:7-9: main/A.html#v: A.MkT :: A.T (A.hs:2:10-12)"
              , "B.hs:9:1 (binder): #v: e :: GHC.Types.Bool (B.hs:9:1)"
              , "B.hs:9:5-8: ghc-prim/GHC-Types.html#v: GHC.Types.True :: GHC.Types.Bool (<wired into compiler>)"
              , "B.hs:9:10-15: parallel-3.2.0.3/Control-Parallel.html#v: Control.Parallel.pseq :: forall a b. a -> b -> b (<no location info>)"
